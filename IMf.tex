\declareIM{f}{F}{2021-06-15}{AOS using Corner raft}{AOS Corner}
Executive Summary:

Use a notebook to process corner raft \texttt{SW0/1} simulated data, publishing wavefront error events

\XXX{Use NTS as per Sandrine}

\XXX{Does not map to P6}

\subsection{Goals of IM}

\XXX{Input from butler.  Will either use OCPS or local resources to do processing}
