\declareIM{pf}{pre-F}{2021-08-26}{AOS using Corner Raft, commanding MT}{AOS MT}
\completeIM{\thisIM}{projected 2021-09-09}
...
\item Generate and ingest simulated images with desired pistons (e.g. $[0, -10, 0, 10, 0]$) and appropriate
  metadata
\item As for \IM{ppf} get data from the butler and generate Zernikes, using OCPS to run the pipeline
